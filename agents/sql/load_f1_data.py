...
from agents.sql.agent import load_sql_agent_knowledge
...
def load_f1_data():
    ...
    logger.info("Loading F1 data into the database.")
    ...
    logger.info("F1 data loaded into the database.")
