...
agent_knowledge = Knowledge(
    ...
    # 5 results returned on query
    max_results=5,
    contents_db=demo_db,
)


def load_sql_agent_knowledge():
    """Load the SQL agent knowledge from the knowledge directory"""
    logger.info("Loading SQL agent knowledge from the knowledge directory.")
    agent_knowledge.add_content(path=str(knowledge_dir))
    logger.info("SQL agent knowledge loaded.")


# ============================================================================
# Setup Semantic Model for SQL Agent
# ============================================================================
...
sql_agent = Agent(
    ...
    tools=[
        SQLTools(db_url=get_db_url(), enable_list_tables=False),
    ...
    # Add tools to search the knowledge base on-demand
    search_knowledge=True,
    # Add tools to read the tool call history
    markdown=True,
    db=demo_db,
)
